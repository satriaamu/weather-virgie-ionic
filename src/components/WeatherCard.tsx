    ...
    <IonCard color="danger">
      <IonCardContent>
        <IonRow className="ion-align-items-center">
          <IonIcon icon={warning} className="ion-margin-right" size="large" />
        ...
        {city && (
          <IonCardHeader>
            ...
            <IonCardSubtitle className="ion-text-center">
              <p>
                {date_string.getHours().toString().padStart(2, "0")}:
                {date_string.getMinutes().toString().padEnd(2, "0")}
              </p>
              <p>
                {date_string?.getDate()}/{date_string.getMonth()}/
        ...
        <IonCardContent className="ion-text-center">
          ...
          {temp && (
            <IonText>
              <p>
                {temp}{" "}
                {units === "standard" ? "K" : units === "metric" ? "°C" : "°F"}
              </p>
            </IonText>
          )}
        </IonCardContent>
